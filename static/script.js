$(async function () {
  ...
  const $recExploreBtn = $("#recExploreBtn");
    ...
    $(`   
            <div class="card mb-3 " style="width: 900px;">
                <div class="row no-gutters">
                    <div class="col-md-4">
                        <img src=${cate.strCategoryThumb} class="card-img" alt="Loading picture">
                    </div>
                    <div class="col-md-8">
                        <div class="card-body">
  ...
  async function loadRecipesPage() {
    ...
    hide($filters);
    $recTitle.html(`
          <h5 class="d-inline"><b>POPULAR RECIPES</b></h5>          
          <hr>
        `);
    showLoadingView();
  ...
  $("#searchForm").on('submit', async function (e) {
    ...
    // *************************************************
  // handle the recipe refresh (explore more) button
  $("#recExploreBtn").on('click', loadRecipesPage);
  // *************************************************
